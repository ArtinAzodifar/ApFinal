...
public class Player1controll : MonoBehaviour
{
    ...
    private void move()
    {
        ...
        //character direction
        transform.localScale = movingInput.x > 0 ? new Vector3(2, 2, 2) : movingInput.x < 0 ? transform.localScale = new Vector3(-2, 2, 2) : transform.localScale = transform.localScale;
